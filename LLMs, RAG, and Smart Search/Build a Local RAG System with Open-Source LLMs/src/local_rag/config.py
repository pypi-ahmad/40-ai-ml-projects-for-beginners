"""Application configuration for local RAG system."""
...
class ChunkingSettings(BaseModel):
    ...
    chunk_overlaps: list[int] = Field(default_factory=lambda: [32, 64, 128])
...
class RetrievalSettings(BaseModel):
    ...
    default_k: int = 5
    candidate_ks: list[int] = Field(default_factory=lambda: [3, 5, 10])
...
class AppSettings(BaseSettings):
    ...
    collection_name: str = "linux_local_rag"
